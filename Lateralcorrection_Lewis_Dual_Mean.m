...
leerrot = korrot(330:402,845:917,1); 
leergruen = korgruen(330:402,845:917,1);
...
imwrite(bild,['Dual_Mean_lateralcorrected_Lewis_' FileName],'Resolution', 72, 'Compression', 'none');